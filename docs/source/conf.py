...
# multi_level_stacking documentation build
...
from multi_level_stacking import __version__ as release

# -- Project information -----------------------------------------------------

project = "multi_level_stacking"
author = "Kedro"
...
htmlhelp_basename = "multi_level_stackingdoc"
...
latex_documents = [
    (
        master_doc,
        "multi_level_stacking.tex",
        "multi_level_stacking Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "multi_level_stacking",
        "Project multi_level_stacking codebase.",
        "Data-Science",
    )
]
